        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-xs-5">
                        ...
                        <h2>${subscription.getName()}</h2>
                    </div>
                    <div class="col-xs-7">
                        <a href="#addTariffServiceModal"  class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE147;</i>
                            <span><fmt:message key="new.tariffs.add.service"/></span></a>
            ...
            <form action="/add/tariff/service" method="post">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <thead>
                    <tr>
                        <th><fmt:message key="name.sub"/></th>
                        <th><fmt:message key="list.days_amount.list"/></th>
                        <th><fmt:message key="name.tariff"/></th>
